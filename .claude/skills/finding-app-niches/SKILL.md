...
2. **Browse relevant categories**:
   ...
   - Screenshot the top charts: `GET /api/v1/devices/{deviceId}/screenshot?path=/Users/loaner/mobai-reports/niche-analysis/{identifier}&name=category-{name}`
...
Create a self-contained HTML report at `/Users/loaner/mobai-reports/niche-analysis/{identifier}/index.html`.
