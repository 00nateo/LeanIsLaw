...
3. Capture: `GET /api/v1/devices/{deviceId}/screenshot?path=/Users/loaner/mobai-reports/app-screenshots/{bundleId}/raw&name=slide-{N}`

The screenshot endpoint saves the PNG to disk and returns JSON with the file path:
```json
{"path": "/Users/loaner/mobai-reports/app-screenshots/com.example.app/raw/slide-1.png", "format": "png"}
```
...
Save all raw screenshots to `/Users/loaner/mobai-reports/app-screenshots/{bundleId}/raw/`.

## Step 5: Build the HTML Page

Generate a **single self-contained `index.html`** file at `/Users/loaner/mobai-reports/app-screenshots/{bundleId}/index.html`.
...
- **Mockup PNG** — copy from the skill directory to `/Users/loaner/mobai-reports/app-screenshots/{bundleId}/mockup.png`.
...
1. Ensure these files exist in `/Users/loaner/mobai-reports/app-screenshots/{bundleId}/`:
