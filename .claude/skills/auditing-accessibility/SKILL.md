...
2. **Capture screenshot**: `GET /api/v1/devices/{deviceId}/screenshot?path=/Users/loaner/mobai-reports/accessibility-audit/{bundleId}&name=screen-{N}` or via DSL
...
Create a self-contained HTML report at `/Users/loaner/mobai-reports/accessibility-audit/{bundleId}/index.html`.
