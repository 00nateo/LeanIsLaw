...
3. **Capture the paywall screen(s)**:
   - Screenshot: `GET /api/v1/devices/{deviceId}/screenshot?path=/Users/loaner/mobai-reports/paywall-research/{identifier}&name=paywall-{appName}-{N}`
...
Create a self-contained HTML report at `/Users/loaner/mobai-reports/paywall-research/{identifier}/index.html`.
