...
2. **Navigate to each key screen** and capture:
   - Screenshot: `GET /api/v1/devices/{deviceId}/screenshot?path=/Users/loaner/mobai-reports/localization-test/{bundleId}&name=en-screen-{N}`
...
2. **Screenshot**: `GET /api/v1/devices/{deviceId}/screenshot?path=/Users/loaner/mobai-reports/localization-test/{bundleId}&name={locale}-screen-{N}`
...
Create a self-contained HTML report at `/Users/loaner/mobai-reports/localization-test/{bundleId}/index.html`.
