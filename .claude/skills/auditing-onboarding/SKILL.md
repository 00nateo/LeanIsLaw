...
2. **At each screen**:
   - Capture screenshot: `GET /api/v1/devices/{deviceId}/screenshot?path=/Users/loaner/mobai-reports/onboarding-audit/{bundleId}&name=screen-{N}`
...
Create a self-contained HTML report at `/Users/loaner/mobai-reports/onboarding-audit/{bundleId}/index.html`.
