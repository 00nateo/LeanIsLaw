...
3. **For each competitor** (top 5 or user-specified):
   - Screenshot the listing: `GET /api/v1/devices/{deviceId}/screenshot?path=/Users/loaner/mobai-reports/competitor-analysis/{identifier}&name=listing-{appName}`
...
Create a self-contained HTML report at `/Users/loaner/mobai-reports/competitor-analysis/{identifier}/index.html`.
